...
CraftWorld::CraftWorld()
{
	...
	blockTypes.push_back(hc17());
	
	blockTypes.push_back(coalblock());
    blockTypes.push_back(haybale());
	blockTypes.push_back(enderchest());
	blockTypes.push_back(acacialog());
	blockTypes.push_back(acaciaplank());
	blockTypes.push_back(podzol());
